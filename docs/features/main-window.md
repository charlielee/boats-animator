...
* **Confirm take:** select this to rename all of the capture frames' file names to be sequential.
...
* **About Boats Animator:** select this to display useful information about the application.
...
Select this to render the captured frames as a video file. See [Export Video](export-video.md) for further information. You must capture at least one frame for this option to be available.
